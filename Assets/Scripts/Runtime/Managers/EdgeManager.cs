...
namespace Runtime.Managers
{
    public class EdgeManager : MonoBehaviour
    {
        ...
        private void SubscribeEvents() =>  ShakeSignals.Instance.onEdgeShake += OnEdgeShake;
        ...
        private void UnsubscribeEvents() => ShakeSignals.Instance.onEdgeShake -= OnEdgeShake;
